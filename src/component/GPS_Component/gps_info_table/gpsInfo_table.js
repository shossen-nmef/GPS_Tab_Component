                            ...
                            <TableBody>
                                <TableRow>
                                    <TableCell style={{ width: '15%'}}>
                                        <FormLabel className={classes.rightText} component="legend" >GPS Serial #</FormLabel>
                                    </TableCell>
                                    <TableCell style={{ width: '30%'}}>
                                        <TextField className={classes.paper} fullWidth placeholder="Enter Gps Id" size="small" variant="outlined" />
                                    </TableCell>
                                    <TableCell style={{ width: '15%'}}>
                                        <FormLabel className={classes.rightText} component="legend">GPS Order</FormLabel>
                                    </TableCell>
                                ...
                                <TableRow>
                                    <TableCell style={{ width: '15%' }}>
                                        <FormLabel className={classes.rightText} component="legend" >Business Name</FormLabel>
                                    </TableCell>
                                    <TableCell style={{ width: '30%' }}>
                                        <TextField className={classes.paper} fullWidth placeholder="Business Name" size="small" variant="outlined" />
                                    </TableCell>
                                    <TableCell style={{ width: '15%' }}>
                                        <FormLabel className={classes.rightText} component="legend">Aspen Ordered</FormLabel>
                                    </TableCell>
                                    <TableCell style={{ width: '50%' }}>
                                        <FormControl component="fieldset">
                                            <RadioGroup row aria-label="position" name="position" defaultValue="No">
                                ...
                                <TableRow>
                                    <TableCell style={{ width: '15%' }}>
                                        <FormLabel className={classes.rightText} component="legend" >* Contact Person</FormLabel>
                                    </TableCell>
                                    <TableCell style={{ width: '30%' }}>
                                        <TextField className={classes.paper} fullWidth placeholder="Enter Contact Person" color="secondary" size="small" variant="outlined" />
                                    </TableCell>
                                    <TableCell style={{ width: '15%' }}>
                                        <FormLabel className={classes.rightText} component="legend">GPS Scheduled</FormLabel>
                                    </TableCell>
                                    <TableCell style={{ width: '50%' }}>
                                        <FormControl component="fieldset">
                                            <RadioGroup row aria-label="position" name="position" defaultValue="No">
                                ...
                                <TableRow>
                                    <TableCell style={{ width: '15%' }}>
                                        <FormLabel className={classes.rightText} component="legend" >* Phone Number Primary</FormLabel>
                                    </TableCell>
                                    <TableCell style={{ width: '30%' }}>
                                        < NMEFTextPhoneField
                                    ...
                                    <TableCell style={{ width: '15%' }}>
                                        <FormLabel className={classes.rightText} component="legend">GPS Installed</FormLabel>
                                    </TableCell>
                                    <TableCell style={{ width: '50%' }}>
                                        <FormControl component="fieldset">
                                            <RadioGroup row aria-label="position" name="position" defaultValue="No">
                                ...
                                <TableRow>
                                    <TableCell style={{ width: '15%' }}>
                                        <FormLabel className={classes.rightText} component="legend" >* Phone Number Secondary</FormLabel>
                                    </TableCell>
                                    <TableCell style={{ width: '30%' }}>
                                        <NMEFTextPhoneField
                                    ...
                                    <TableCell style={{ width: '15%' }}>
                                        <FormLabel className={classes.rightText} component="legend">GPS Located</FormLabel>
                                    </TableCell>
                                    <TableCell style={{ width: '50%' }}>
                                        <FormControl component="fieldset">
                                            <RadioGroup row aria-label="position" name="position" defaultValue="No">
                                ...
                                <TableRow>
                                    <TableCell style={{ width: '15%' }}>
                                        <FormLabel className={classes.rightText} component="legend" >Email</FormLabel>
                                    </TableCell>
                                    <TableCell style={{ width: '30%' }}>
                                        <TextField className={classes.paper} fullWidth placeholder="Enter Email" size="small" variant="outlined" />
                                    </TableCell>
                                    <TableCell style={{ width: '15%' }}>
                                        <FormLabel className={classes.rightText} component="legend">GPS Auto-Report Successful</FormLabel>
                                    </TableCell>
                                    <TableCell style={{ width: '50%' }}>
                                        <FormControl component="fieldset">
                                            <RadioGroup row aria-label="position" name="position" defaultValue="No">
                                ...
                                <TableRow>
                                    ...
                                    <TableCell style={{ width: '15%' }}>
                                        <FormLabel className='gps-tracking' component="legend">GPS Tracking</FormLabel>
                                        <FormLabel className='gps_address' component="legend">Address</FormLabel>
                                    </TableCell>

                                    <TableCell style={{ width: '30%' }}>
                                        <TextField className='gps_tracking_input' fullWidth placeholder="Enter GPS Tracking data" size="small" variant="outlined" />
                                        <GoogleMap className='gps_address_input' placeholder="Enter Address" updateMapInfo={updateMapInfo} />
                                    </TableCell>

                                    <TableCell style={{ width: '15%' }}>
                                        <FormLabel className='special_request' component="legend">Special Requests</FormLabel>
                                    </TableCell>
